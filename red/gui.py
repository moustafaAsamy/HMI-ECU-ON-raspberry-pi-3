...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_4.setStyleSheet("background-image: url(:/newPrefix/shutdown (2).png);")
        ...
        self.label.setStyleSheet("background-image: url(:/newPrefix/CaptureF.PNG);")
        self.label.setText("")
        ...
        self.label_2.setStyleSheet("background-image: url(:/newPrefix/F.PNG);")
...
"border-image: url(:/newPrefix/th (3).jfif);")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(70, 80, 75, 23))
